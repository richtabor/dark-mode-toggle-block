...
function updateToggleState(toggle, isDark) {
	...
	toggle.setAttribute(
		'aria-label',
		isDark
			? __('Switch to light mode, currently dark', 'dark-mode-toggle-block')
			: __('Switch to dark mode, currently light', 'dark-mode-toggle-block')
	);
}
...
function toggleTheme() {
	...
	darkModeToggles.forEach(toggle => updateToggleState(toggle, isDark));
}
